...
class Boutons_selection:
    ...
    def fun1(self, controller, Xnnn):
        ...
        """
        print("à l'entrée de la fonctuion fun1, controller.jpp =", controller.jpp.get())
        controller.jpp.set("TOTO !!!")
        print("en sortie de la fonctuion fun1, controller.jpp =", controller.jpp.get())
        # Info_defaut.__init__(self, Info_defaut, controller)
        ...
        try:
            ...
            self.boutons[Xnnn] = tk.Button(self, text=Livre[Xnnn][1], relief="raised", bd=10, font=LARGE_FONT,
                                           image=self.illustrations[Xnnn], compound="right",
                                            command = lambda: [self.fun1(controller, Xnnn)])
...
class Info_defaut(tk.Frame, Boutons_selection):
    ...
    def __init__(self, parent, controller):
        ...
        print("dans la classe info_defaut controller.jpp : ", controller.jpp.get())
        self.label = tk.Label(self, text=controller.jpp.get(), font=LARGE_FONT)
